...
import { PLAINTE_STATUTS } from '../plainteConstants.js';
...
export default function PlainteFormModal({
      ...
      <ModalDialog variant="outlined" sx={MODAL_SX}>
        <Box sx={{ px: 3, py: 2.5, borderBottom: '1px solid', borderColor: 'divider' }}>
          <Stack direction="row" spacing={1.5} alignItems="center">
            ...
            <Typography level="title-lg" sx={{ fontWeight: 700 }}>
              {isEdit ? 'Modifier la plainte' : 'Nouvelle plainte'}
            </Typography>
          </Stack>
        </Box>
        <Box component="form" onSubmit={handleSubmit}>
          ...
          <Stack direction="row" spacing={1.5} justifyContent="flex-end" sx={{ px: 3, py: 2, borderTop: '1px solid', borderColor: 'divider' }}>
            ...
            <Button type="submit" loading={loading}>{isEdit ? 'Enregistrer' : 'Créer la plainte'}</Button>
          </Stack>
        </Box>
      </ModalDialog>
    </Modal>
