...
PERMISSION_LABELS[PERMISSIONS.FACTURATION.FACTURE_VALIDER] = 'Factures — approuver';
PERMISSION_LABELS[PERMISSIONS.FACTURATION.FACTURE_EXPORT] = 'Factures — imprimer / exporter';
PERMISSION_LABELS[PERMISSIONS.FACTURATION.FACTURE_REMISE] = 'Factures — appliquer une remise';
PERMISSION_LABELS[PERMISSIONS.FACTURATION.FACTURE_REGLER] = 'Factures — régler (paiement total ou partiel)';
