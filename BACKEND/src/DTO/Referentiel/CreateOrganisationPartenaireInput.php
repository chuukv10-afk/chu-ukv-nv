...
final class CreateOrganisationPartenaireInput
{
    public function __construct(
        #[Assert\NotBlank(message: 'Le code de l\'organisation est obligatoire.')]
        #[Assert\Length(max: 15, maxMessage: 'Le code ne peut pas dépasser {{ limit }} caractères.')]
        public string $code = '',
