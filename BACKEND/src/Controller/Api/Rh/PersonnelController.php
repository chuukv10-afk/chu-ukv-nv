...
final class PersonnelController extends AbstractController
{
    ...
    #[Route('', name: 'api_rh_personnels_index', methods: ['GET'])]
    #[IsGranted(RhPermissions::PERSONNEL_READ)]
    ...
    #[Route('/meta', name: 'api_rh_personnels_meta', methods: ['GET'])]
    #[IsGranted(RhPermissions::PERSONNEL_READ)]
    ...
    #[Route('/lookups', name: 'api_rh_personnels_lookups', methods: ['GET'])]
    #[IsGranted(RhPermissions::PERSONNEL_READ)]
    public function lookups(): JsonResponse
    {
        return $this->apiSuccess(
            $this->personnelService->getFormLookups(),
            'Listes d\'affectation récupérées avec succès.',
        );
    }

    #[Route('/export', name: 'api_rh_personnels_export', methods: ['GET'])]
    #[IsGranted(RhPermissions::PERSONNEL_EXPORT)]
    ...
    #[Route('/{id}/avatar', name: 'api_rh_personnels_avatar_show', methods: ['GET'])]
    ...
    #[Route('/{id}/avatar/prepare', name: 'api_rh_personnels_avatar_prepare', methods: ['POST'])]
    #[IsGranted(RhPermissions::PERSONNEL_UPDATE)]
    public function prepareAvatar(string $id, #[MapRequestPayload] PrepareStoredFileInput $input): JsonResponse
    {
        $personnel = $this->personnelService->getById($id);
        $this->denyAccessUnlessGranted(RhPermissions::PERSONNEL_UPDATE, $personnel);
    ...
    #[Route('/{id}/avatar/confirm', name: 'api_rh_personnels_avatar_confirm', methods: ['POST'])]
    #[IsGranted(RhPermissions::PERSONNEL_UPDATE)]
    ...
    #[Route('/{id}/avatar', name: 'api_rh_personnels_avatar_upload', methods: ['POST'])]
    #[IsGranted(RhPermissions::PERSONNEL_UPDATE)]
    ...
    #[Route('/{id}/avatar', name: 'api_rh_personnels_avatar_delete', methods: ['DELETE'])]
    #[IsGranted(RhPermissions::PERSONNEL_UPDATE)]
    ...
    #[Route('/{id}/signature', name: 'api_rh_personnels_signature_show', methods: ['GET'])]
    ...
    #[Route('/{id}/signature/prepare', name: 'api_rh_personnels_signature_prepare', methods: ['POST'])]
    #[IsGranted(RhPermissions::PERSONNEL_UPDATE)]
    ...
    #[Route('/{id}/signature/confirm', name: 'api_rh_personnels_signature_confirm', methods: ['POST'])]
    #[IsGranted(RhPermissions::PERSONNEL_UPDATE)]
    ...
    #[Route('/{id}/signature', name: 'api_rh_personnels_signature_upload', methods: ['POST'])]
    #[IsGranted(RhPermissions::PERSONNEL_UPDATE)]
    ...
    #[Route('/{id}/signature', name: 'api_rh_personnels_signature_delete', methods: ['DELETE'])]
    #[IsGranted(RhPermissions::PERSONNEL_UPDATE)]
    ...
    #[Route('/{id}', name: 'api_rh_personnels_show', methods: ['GET'])]
    #[IsGranted(RhPermissions::PERSONNEL_READ)]
    public function show(string $id): JsonResponse
    {
        $personnel = $this->personnelService->getById($id);
        $this->denyAccessUnlessGranted(RhPermissions::PERSONNEL_READ, $personnel);
    ...
    #[Route('', name: 'api_rh_personnels_create', methods: ['POST'])]
    #[IsGranted(RhPermissions::PERSONNEL_CREATE)]
    ...
    #[Route('/{id}', name: 'api_rh_personnels_update', methods: ['PUT'])]
    #[IsGranted(RhPermissions::PERSONNEL_UPDATE)]
    ...
    #[Route('/{id}', name: 'api_rh_personnels_delete', methods: ['DELETE'])]
    #[IsGranted(RhPermissions::PERSONNEL_DELETE)]
    ...
    private function assertCanViewAvatar(Personnel $target, ?Personnel $viewer): void
    {
        ...
        $this->denyAccessUnlessGranted(RhPermissions::PERSONNEL_READ, $target);
    }
}
